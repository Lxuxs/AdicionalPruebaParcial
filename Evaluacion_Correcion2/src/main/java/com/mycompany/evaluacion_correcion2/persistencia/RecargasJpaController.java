...
public class RecargasJpaController implements Serializable {
    ...
    public RecargasJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void edit(Recargas recargas) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                int id = recargas.getIdRec(); // Corregido de getIdReca() a getIdRec()
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                recargas.getIdRec(); // Corregido de getIdReca() a getIdRec()
